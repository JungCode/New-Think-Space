...
export const createANewDocument = async (token: string) => {
  try {
    const response = await axios.post<{ documentId: string }>(
      "https://54.252.242.166:3000/documents",
      {
        title: "New page",
      },
      {
...
export const getUserDocuments = async (token: string): Promise<Document[]> => {
  try {
    const response = await axios.get<Document[]>(
      "https://54.252.242.166:3000/documents/user",
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
...
export const useOwner = async (
  ...
  try {
    const response = await axios.get<{ owner: string }>(
      `https://54.252.242.166:3000/documents/${roomId}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
...
export const deleteADocument = async (documentId: string, token: string) => {
  try {
    const response = await axios.delete(
      `https://54.252.242.166:3000/documents/${documentId}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
...
export const inviteAUserToRoom = async (
  ...
  try {
    const response = await axios.post<{ roomRes: string }>(
      `https://54.252.242.166:3000/rooms/${roomId}`,
      {
        email,
        title,
      },
...
export const saveAUser = async (email: string, username: string) => {
  try {
    const response = await axios.post(`https://54.252.242.166:3000/`, {
      username: username,
      email: email,
    });
    return response.data;
...
export const getSharedDocuments = async (token: string, userId: string) => {
  try {
    const response = await axios.get<Document[]>(
      `https://54.252.242.166:3000/rooms/${userId}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
...
export const getUsersByRoom = async (roomId: string, token: string) => {
  try {
    const response = await axios.get<Document[]>(
      `https://54.252.242.166:3000/byRoom/${roomId}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
...
export const removeARoom = async (
  ...
  try {
    const response = await axios.post(
      `https://54.252.242.166:3000/rooms/removeARoom/${roomId}`,
      {
        userEmail,
      },
      {
...
export const askAIQuestion = async (
  ...
  try {
    const response = await fetch("https://54.252.242.166:3000/askAIQuestion", {
      method: "POST",
      headers: {
...
export const chatToDocument = async (
  ...
  try {
    const response = await fetch(
      "https://54.252.242.166:3000/askAIQuestion/chatToDocument",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
